  ...
  useEffect(() => {
    if (selectedDay && schedule) {
      const dayRoutes = schedule.routes.filter(
        (r) =>
          format(r.date, "yyyy-MM-dd") === format(selectedDay, "yyyy-MM-dd")
      );
                ...
                >
                  <Popup>
                    <div className="min-w-[200px] p-2">
                      <div className="mb-1 text-lg font-bold" style={{ color }}>
                        Etape {idx + 1}
                      </div>
                      <div className="font-semibold">{client.name}</div>
                      ...
                      <div className="rounded bg-gray-100 p-2 text-sm">
                        ...
                        <div>
                          ⏱️ {intervention.estimatedDurationMinutes} minutes
                        </div>
