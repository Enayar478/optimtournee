  ...
  return (
    <section ref={ref} className="relative overflow-hidden py-20">
      ...
      <div className="absolute inset-0">
        <div className="from-forest-surface/50 absolute inset-0 bg-gradient-to-b via-white to-white" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto grid max-w-5xl gap-8 lg:grid-cols-2">
          {/* Sliders Panel */}
          <motion.div
            className="rounded-2xl border bg-white/80 p-8 shadow-lg backdrop-blur-xl"
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  className="bg-forest/20 accent-forest h-2 w-full cursor-pointer appearance-none rounded-lg"
                />
              </div>
          ...
          {/* Results Panel */}
          <motion.div
            className="bg-forest relative overflow-hidden rounded-2xl p-8 text-white shadow-lg"
            initial={{ opacity: 0, x: 50 }}
            animate={isInView ? { opacity: 1, x: 0 } : {}}
          ...
          >
            ...
            <h3 className="relative z-10 mb-6 text-lg font-semibold text-white/90">
